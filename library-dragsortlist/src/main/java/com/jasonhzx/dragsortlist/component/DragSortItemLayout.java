...
public class DragSortItemLayout extends FrameLayout {
    ...
    public DragSortItemLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragSortItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnStateChangeListener {
        ...
        void onLeftOpen(DragSortItemLayout layout);

        void onRightOpen(DragSortItemLayout layout);

        void onClose(DragSortItemLayout layout);
